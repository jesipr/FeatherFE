  ...
  export default {
    ...
    methods: {
      onSubmit() {
        ...
        axios.get(this.request_url+"/Feather/search", {
          params: {
            q: this.form.search,
      ...
      init() {
        this.loading = true;
        axios({
          url: this.request_url+"/Feather/chart/1",
          method: "get"
        })
          .then(response => {
        ...
        axios({
          url: this.request_url+"/Feather/chart/2",
          method: "get"
        })
          .then(response => {
            for (var i = 0; i < response.data.length; i++) {
        ...
        axios({
          url: this.request_url+"/Feather/chart/3",
          method: "get"
        })
          .then(response => {
            for (var i = 0; i < response.data.length; i++) {
        ...
        axios({
          url: this.request_url+"/Feather/chart/4",
          method: "get"
        })
          .then(response => {
            for (var i = 0; i < response.data.length; i++) {
        ...
        axios({
          url: this.request_url+"/Feather/chart/5",
          method: "get"
        })
          .then(response => {
            for (var i = 0; i < response.data.length; i++) {
        ...
        axios({
          url: this.request_url+"/Feather/chart/6",
          method: "get"
        })
          .then(response => {
            for (var i = 0; i < response.data.length; i++) {
